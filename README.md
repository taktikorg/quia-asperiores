...
[![build status](https://img.shields.io/travis/taktikorg/quia-asperiores/master.svg?style=flat-square)](https://travis-ci.org/taktikorg/quia-asperiores)
[![npm version](https://img.shields.io/npm/v/@taktikorg/quia-asperiores.svg?style=flat-square)](https://www.npmjs.com/package/@taktikorg/quia-asperiores)
...
```sh
npm install @taktikorg/quia-asperiores @stripe/stripe-js
```
...
import {
  ...
  useStripe,
  useElements,
} from '@taktikorg/quia-asperiores';
